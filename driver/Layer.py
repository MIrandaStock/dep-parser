...
class Biaffine(nn.Module):
    ...
    def __repr__(self):
        """ 自定义 print(model) 的结果 """
        return self.__class__.__name__ + ' (' + 'in1_features=' + str(
            self.in1_features) + ', in2_features=' + str(
                self.in2_features) + ', out_features=' + str(
                    self.out_features) + ')'
